...
export const ROLE_PERMISSIONS: Record<string, Set<string>> = {
  ...
  maintenance_director: new Set([
    ...
    'settings_departments:view', 'settings_departments:create', 'settings_departments:update', 'settings_departments:delete',
  ...
  plant_manager: new Set([
    ...
    'kpis:view', 'settings_machines:view', 'settings_machines:update',
    'settings_departments:view', 'settings_departments:create', 'settings_departments:update', 'settings_departments:delete', 'settings_users:view',
    'settings_devices:view', 'settings_devices:update',
    'costs:view', 'costs:update',
    'maintenance_plans:view', 'inventory:view', 'intelligence:view',
    'factory_map:view', 'dashboards:view', 'wo_approval:view',
  ...
  director: new Set([
    ...
    'kpis:view', 'settings_machines:view', 'settings_devices:view', 'costs:view', 'settings_departments:view',
    'maintenance_plans:view', 'inventory:view', 'intelligence:view',
    'factory_map:view', 'dashboards:view', 'wo_approval:view',
    'suppliers:view', 'purchase_orders:view', 'machine_reports:view', 'settings_escalation:view', 'job_orders:view',
    'calendar:view',
