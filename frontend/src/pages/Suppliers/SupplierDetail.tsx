              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-800 text-xs text-gray-500 uppercase tracking-wider">
                    ...
                    <th className="px-3 py-3 text-left">{t('inventory.description', 'Description')}</th>
          ...
          <div>
            ...
            {orders.length === 0 ? (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-800 text-xs text-gray-500 uppercase tracking-wider">
                    <th className="px-3 py-3 text-left">{t('suppliers.poNumber', 'PO #')}</th>
                    <th className="px-3 py-3 text-left">{t('common.date', 'Date')}</th>
                    <th className="px-3 py-3 text-center">{t('suppliers.status', 'Status')}</th>
                    <th className="px-3 py-3 text-center">{t('suppliers.tabItems', 'Items')}</th>
                    <th className="px-3 py-3 text-right">{t('suppliers.totalCol', 'Total')}</th>
                    <th className="px-3 py-3 text-left">{t('suppliers.expectedCol', 'Expected')}</th>
                  </tr>
                </thead>
                <tbody>
                  {orders.map(po => (
